...
public class CustomerDetailActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @InjectView(R.id.customer_since_value)
    TextView mCustomerSince;
    @InjectView(R.id.customer_lifetime_value)
    TextView mCustomerLifeTimeValue;
    @InjectView(R.id.customer_total_visits_value)
    TextView mCustomerTotalVisitsValue;
    @InjectView(R.id.customer_fulfilled_orders_value)
    TextView mCustomerFulfilledValue;
    @InjectView(R.id.customer_store_credits_value)
    TextView mCustomerStoreCredits;
    @InjectView(R.id.customer_name)
    TextView mCustomerName;
    @InjectView(R.id.customer_id)
    TextView mCustomerId;
    @InjectView(R.id.customer_detail_container)
    SwipeRefreshLayout mSwipeRefreshLayout;
    @InjectView(R.id.customer_detail_sections_viewpager)
    ViewPager mCustomerViewPager;
    @InjectView(R.id.customer_detail_sections_tab)
