...
public class orderDetailFulfillmentAdapter extends BaseAdapter {

    private final FulfillmentMoveToRow.MoveToListener mListener;
    List<IData> mData = new ArrayList<IData>();

    public orderDetailFulfillmentAdapter(Context context, List<IData> data, FulfillmentMoveToRow.MoveToListener listener) {
        mData = data;
        mListener = listener;
    }
