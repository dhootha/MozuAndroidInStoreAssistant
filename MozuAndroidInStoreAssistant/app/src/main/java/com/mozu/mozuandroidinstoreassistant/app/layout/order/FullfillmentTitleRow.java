...
public class FullfillmentTitleRow extends RelativeLayout implements IRowLayout {
    ...
    public void bindData(IData data) {
        ...
        if(data instanceof FullfillmentTitleDataItem){
            FullfillmentTitleDataItem dataItem = (FullfillmentTitleDataItem)data;
            if (dataItem.getTitle() != null) {
                mTitleTextView.setText(dataItem.getTitle());
            }
            if (dataItem.getPendingCount() != null) {
                mPendingTextView.setText(String.valueOf(dataItem.getPendingCount()));
            }
